...
function run_script() {
  ...
  if cd /var/www; then
    ...
    echo "Created By: Fazle Rabbi"
    echo "----Version: 0.0.2---"
    echo "--https://github.com/irabbi360----"
    echo "============================================================"
    ...
    clone_url='git@github.com:irabbi360/something.git' #your git repository url example: git@url.com:user/repo.git
